...
my $_DSN = "DBI:mysql:database=test:host=localhost:user=root:password=ashokkumar";
...
my $moteListRoot = "select moteid,ip_addr from test.motes where active='1'";
...
my $run_analyze;
chdir('/var/www/web/html') or die "$!";
$AnalyzeConnectivity = "java AnalyzeConnectivity";
